            ...
            <main className="overflow-hidden">
                ...
                <section>
                    <div className="relative pt-24 md:pt-36">
                        ...
                        <div className="mx-auto max-w-7xl px-6">
                            <div className="text-center sm:mx-auto lg:mr-auto lg:mt-0">
                                ...
                                <Button
                                    asChild
                                    size="lg"
                                    className="rounded-xl px-8 text-base shadow-xl shadow-primary/20 bg-primary hover:bg-primary/90 transition-all active:scale-95"
                                >
                                    <Link href="#link">
                                ...
                                <Button
                                    ...
                                    size="lg"
                                    variant="ghost"
                                    className="h-12 rounded-xl px-8 text-base hover:bg-muted/50 transition-all active:scale-95"
                                >
                                    <Link href="#link">
                        ...
                        >
                            <div className="relative mt-12 overflow-hidden px-4 sm:mt-16 md:mt-24 max-w-6xl mx-auto">
                                <div
                                    aria-hidden
                                    className="bg-gradient-to-b from-transparent via-background/20 to-background absolute inset-0 z-10"
                                />
                                <div className="bg-background relative mx-auto overflow-hidden rounded-[2.5rem] border p-2 shadow-2xl shadow-black/10 ring-1 ring-border/50">
                                    <div className="rounded-[2rem] overflow-hidden bg-muted/20">
                                        <img
                                            className="w-full h-auto aspect-[16/10] object-cover hidden dark:block"
                                            src="https://images.unsplash.com/photo-1614850523296-d8c1af93d400?auto=format&fit=crop&q=80&w=2070"
                                            alt="app screen dark"
                                        />
                                        <img
                                            className="w-full h-auto aspect-[16/10] object-cover dark:hidden"
                                            src="https://images.unsplash.com/photo-1614850523296-d8c1af93d400?auto=format&fit=crop&q=80&w=2070"
                ...
                <section className="bg-background pb-24 pt-16 md:pb-40">
                    <div className="group relative m-auto max-w-5xl px-6">
                        <div className="absolute inset-0 z-10 flex scale-95 items-center justify-center opacity-0 duration-500 group-hover:scale-100 group-hover:opacity-100 pointer-events-none">
                            <span className="bg-background/80 backdrop-blur-sm border px-6 py-2 rounded-full text-sm font-medium shadow-xl">
                                Meet Our Customers <ChevronRight className="inline-block size-4 ml-1" />
                            </span>
                        </div>
                        <div className="group-hover:blur-md mx-auto grid grid-cols-2 sm:grid-cols-4 gap-8 md:gap-16 items-center transition-all duration-700 group-hover:opacity-30">
                            {[
                ...
                <section className="bg-background pb-24 pt-16 md:pb-40 overflow-hidden relative">
                    <CreativePricing 
                        tiers={[
                            {
                                name: "Starter",
